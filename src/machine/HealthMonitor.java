...
public class HealthMonitor extends CommandHandler implements Runnable{
    ...
    public static double MAX_PULSE=200, MIN_PULSE=-200, MAX_OXYGEN=100, MIN_OXYGEN=0;
    public static double MAX_TEMP=50, MIN_TEMP=30, MIN_PRESSURE=100, MAX_PRESSURE=0;
    public static double SAFE_PULSE_DIFF=300, SAFE_OXYGEN_DIFF=500;
    public static double SAFE_TEMP_DIFF=500, SAFE_PRESSURE_DIFF=400;
    public static double NORMAL_PULSE=200, NORMAL_OXYGEN=100;
    public static double NORMAL_TEMP=50, NORMAL_PRESSURE=100;
    public static double prevPulse, prevOxygen, currentPulse, currentOxygen;
    public static double prevTemp, prevPressure, currentTemp, currentPressure;
    private boolean on;
    ...
    public void run() {
        while(on){
            ...
            prevPressure = currentPressure;
                ...
                //e.printStackTrace();
                System.out.println("Health Monitor failure");
            }
        }
    }
