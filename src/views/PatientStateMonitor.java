...
public class PatientStateMonitor extends StackPane {
    ...
    public PatientStateMonitor(OperationDashboard dashboard){
        ...
        bloodPressureSignal.getLineChart().setPadding(new Insets(-20,-10,-34,-25));
        temperatureSignal.getLineChart().setPadding(new Insets(-20,-10,-34,-25));
        oxygenLevelSignal.getLineChart().setPadding(new Insets(-20,-10,-25,-25));
