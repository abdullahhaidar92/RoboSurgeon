...
public class Sensor extends Thread {
    ...
    public void startRandoms(){
        ...
        while (on) {
            ...
            y=t%2==0?-y:y;
            currentPulse=(y/1.5)*10+HealthMonitor.NORMAL_PULSE;
            currentPressure=(y/1.5)*20+HealthMonitor.NORMAL_PRESSURE;
            currentTemperature=(y/1.5)*2+HealthMonitor.NORMAL_TEMP;
            currentOxygen=(y/1.5)*15+HealthMonitor.NORMAL_OXYGEN;
            chartValues[0]=y;
            chartValues[1]=y;
            chartValues[2]=y;
            chartValues[3]=y;
